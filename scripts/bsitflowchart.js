...
function make_pdf()
{
    ...
    for (i = 0; i < bsit_course_data.length; i++)
    {
        ...
        if (program_options.includes(bsit_course_data[i].Prefix + bsit_course_data[i].Course_Number))
        {    
            document.getElementById(bsit_course_data[i].Prefix + bsit_course_data[i].Course_Number).appendChild(html_obj);
        }
        else
        {
...
function make_printable_pdf()
{
    ...
    for (i = 0; i < bsit_course_data.length; i++)
    {
        ...
        html_obj.innerHTML = `
        <div class=\"solid_border flex_stack\">
            <p class=\"zero_margin\">` + bsit_course_data[i].Prefix + ` ` + bsit_course_data[i].Course_Number + `: ` + bsit_course_data[i].Course_Name + `</p>
            ` + prerequisite_element + `
        </div>`;
...
function higlight_course()
{
    ...
    for (i = 0; i < bsit_course_data.length; i++)
    {
        ...
        if ((bsit_course_data[i].Course_Number.toLowerCase().includes(search_bar.value.toLowerCase()) == true ||
            bsit_course_data[i].Course_Name.toLowerCase().includes(search_bar.value.toLowerCase()) == true) &&
